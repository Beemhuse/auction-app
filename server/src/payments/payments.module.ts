...
@Module({ imports: [TypeOrmModule.forFeature([PaymentEvent]), RegistrationsModule, TelegramModule], controllers: [PaymentsController], providers: [PaymentsService], exports: [PaymentsService] })
