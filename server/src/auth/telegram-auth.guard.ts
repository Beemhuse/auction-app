...
export class TelegramAuthGuard implements CanActivate {
  constructor(private readonly telegramAuth: TelegramAuthService, private readonly telegramUsers: TelegramUsersService) {}
  canActivate(context: ExecutionContext): boolean {
    ...
    void this.telegramUsers.remember(request.telegramUser);
    return true;
  }
}
