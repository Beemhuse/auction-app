...
import { AuctionRegistration, AuctionResult, DepositRefund, PaymentAttempt, TelegramUser } from './entities';
...
async function checkSchema(): Promise<void> {
  ...
  await dataSource.getRepository(DepositRefund).find({ take: 1 });
